...
if not exist zIllust_\AbyssOrangeMix3_A2.safetensors (
	curl -Lo zIllust_\AbyssOrangeMix3_A2.safetensors^
	https://huggingface.co/WarriorMama777/OrangeMixs/resolve/main/Models/AbyssOrangeMix3/AOM3A2_orangemixs.safetensors
)

if not exist zIllust_\AbyssOrangeMix3_A2.webp (
	curl -Lo zIllust_\AbyssOrangeMix3_A2.webp^
